                        ...
                        <div className='grid w-full grid-cols-8 gap-16'>
                            ...
                            <div className='col-span-2 flex flex-col items-center justify-between'>
                                ...
                                <div>
                                    ...
                                    <h2 className='text-xl font-medium capitilize text-black/75'>Satisfied Clients</h2>
                                </div>
                                ...
                                <div>
                                    ...
                                    <h2 className='text-xl font-medium capitilize text-black/75'>Projects Completed</h2>
                                </div>
                                ...
                                <div>
                                    ...
                                    <h2 className='text-xl font-medium capitilize text-black/75'>Years of Experience</h2>
                                </div>
                            </div>
                        </div>
                    </Layout>
